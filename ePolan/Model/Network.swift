...
enum DBQuery {
    ...
    static func makeRequest(
        ...
        await request.setValue("Bearer \(OAuthManager.shared.useFreshToken())", forHTTPHeaderField: "Authorization")
        return request
    }
    ...
    static func getAllLessonsURL(_ courseId: UUID) -> URL { URL(string: "\(NetworkConstants.baseUrl)/lesson/\(courseId.uuidString)/lessons")! }
